...
int main (){
    ...
    Change_Move_Log_Element(element,1,2,3,4,NO_CHECK,PAWN,BLACK);


    printf("Element_original : %d %d %d %d %d %d %d\n",   element->move->previous_row,
    ...
    printf("Element_copy : %d %d %d %d %d %d %d\n",   element2->move->previous_row,
    ...
    printf ("Element at index 0 : %d %d %d %d %d %d %d\n",   element->move->previous_row,
                                                element->move->previous_col,
                                                element->move->destination_row,
                                                element->move->destination_col,
                                                element->check_state,
    ...
    printf ("Element at index 1 : %d %d %d %d %d %d %d\n",   element->move->previous_row,
                                                element->move->previous_col,
                                                element->move->destination_row,
                                                element->move->destination_col,
                                                element->check_state,
